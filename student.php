...
<body>
<?php     
            $sqc="SELECT * FROM Usertable where unique_id = {$_SESSION['unique_id']}";
    ...
    <section class="form signup">
      ...
      <input type="text" class="incoming_id" name="id" value="<?php echo $row['unique_id']; ?>" hidden>
        ...
        <div class="field input">
          ...
          <input type="text" name="username" readonly value="<?php echo $row['username'] ?>" required>
        </div>
        <div class="field input">
          <label>Email Address</label>
          <input type="email" name="email" readonly value="<?php echo $row['email'] ?>" required>
        </div>
        <div class="field input">
        ...
        <div class="field input">
          ...
          <input type="password" name="password" readonly value="<?php echo $row['password'] ?>" required>
